...
Step 2: Read in five-letter word dictionaries
...
def to_uppercase(*args):
    """This function sets a StringVar() to upper case.
    var : string variable taken from an entry in a tkinter window 
    outside of function
...
def compare_word():
    ...
    entry : entry defined outside of function from a tkinter window
    count : variable set to 0 outside of function
